...
def get_embedding_provider() -> EmbeddingProvider:
    ...
    provider = settings.KG_EMBEDDING_PROVIDER.lower().strip()
    logger.info(f"Creating KG embedding provider: {provider} (model: {settings.KG_EMBEDDING_MODEL})")

    if provider == "gemini" or "gemini" in settings.KG_EMBEDDING_MODEL.lower():
