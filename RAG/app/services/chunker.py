...
def get_chunker(chunk_size: int = 500, chunk_overlap: int = 50) -> DocumentChunker:
    """
    Factory function to get a DocumentChunker instance.
    Used by upload.py to obtain a chunker for background processing.
