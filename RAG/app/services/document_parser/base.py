...
class BaseDocumentParser(ABC):
    ...
    _IMAGE_CAPTION_PROMPT = (
        ...
        "- VIẾT HOÀN TOÀN BẰNG TIẾNG VIỆT (ALWAYS WRITE IN VIETNAMESE).\n"
        "- Viết từ 2-4 câu ngắn gọn, tối đa 400 ký tự.\n"
        "- KHÔNG bắt đầu bằng 'Hình ảnh này cho thấy' hoặc 'Đây là'.\n"
        "- KHÔNG thêm bất kỳ dữ liệu, ngữ cảnh hoặc giải thích nào ngoài những gì có thể nhìn thấy.\n"
        "- Nếu văn bản trong ảnh không đọc được rõ ràng, hãy nêu rõ như vậy."
    )
    ...
    _TABLE_CAPTION_PROMPT = (
        ...
        "- VIẾT HOÀN TOÀN BẰNG TIẾNG VIỆT (ALWAYS WRITE IN VIETNAMESE).\n"
        "- Viết từ 2-4 câu ngắn gọn, tối đa 500 ký tự.\n"
        "- Khách quan - chỉ mô tả những gì có trong bảng."
        "Table:\n"
    )
